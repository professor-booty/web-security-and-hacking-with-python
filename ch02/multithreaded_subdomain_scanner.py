...
if __name__ == "__main__":
    ...
    parser.add_argument("-l","--wordlist", help="File that contains all subdomains to scan. Default is subdomains.txt", default="subdomains.txt")
    parser.add_argument("-t","--num_threads", help="Number of threads to use to scan the domain. Default is 10", default="10", type=int)
    parser.add_argument("-o","--output-file", help="The output text file to write discovered subdomains", default="discovered_subdomains.log")
    ...
    if output_file == 'discovered_subdomains.log':
        output_file = f"{domain.replace('.','_')}_subdomains.log"
